...
export function parseRequestForExcludedSources(
  ...
  endpoint: 'price' | 'quote',
    ...
    if (excludedIds.length > 0) {
        return {
            excludedSources: parseStringArrForERC20BridgeSources(excludedIds),
            includedSources: [],
    ...
    if (includedIds.includes('RFQT')) {
        ...
        return {
            excludedSources: [],
            includedSources: parseStringArrForERC20BridgeSources(['0x', ...includedIds]),
    ...
    return {
        excludedSources: [],
        includedSources: parseStringArrForERC20BridgeSources(includedIds),
        nativeExclusivelyRFQT: false,
    };
}

export function parseStringArrForERC20BridgeSources(sources: string[]): ERC20BridgeSource[] {
...
export function parseAffiliateFeeOptions(req: express.Request): AffiliateFee {
